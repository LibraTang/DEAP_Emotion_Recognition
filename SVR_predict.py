...
# load trained model
Val_R = joblib.load("model/SVR_val_model.pkl")
Aro_R = joblib.load("model/SVR_aro_model.pkl")
Dom_R = joblib.load("model/SVR_dom_model.pkl")
Lik_R = joblib.load("model/SVR_lik_model.pkl")
